        ...
        <div class="row mb-4 mt-4">
          <div class="col-md-12">
            <div class="bg-white p-3 rounded shadow border-radius">
              <h2 class="text-lg font-weight-bold mb-2">Selamat Datang,  {{ Auth::user()->name }}❤️ <Span class="text-base font-weight-normal"> Di sini Anda dapat mengelola Gym Anda</Span></h2>
            </div>
          </div>
        </div>
          <!-- Box 1 -->
